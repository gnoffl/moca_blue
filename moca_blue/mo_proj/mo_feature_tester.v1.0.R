...
dirpath_2 <- "./out"
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
file1 <- "20231115ArthS0ArthS02_e3-cwm-W2_gene_nonefeat_mima_weight.csv"
file3 <- "Arabidopsis_thaliana.TAIR10.pep.mercator4.5.txt"
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
cont_table_B <- table(mm0_mapman$epm, mm0_mapman$type.y)
