...
dirpath_2 <- "./out"
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
file1 <- "20231115ArthM0ArthM02_e3-cwm-W2_gene_none-q1q9.csv"
file2 <- "arabidopsis_M0_preds.csv" # file with predicted probabilies for expression 0-1
file3 <- "Arabidopsis_thaliana.TAIR10.pep.mercator4.5.txt"  # GO-term enrichment
file4 <- "arabidopsis_preds_all_genes_leaf.csv"   # file with measurement of models (TPM, quartile classes 0,1,2)
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
colnames(ss_model1) <- c("loc_ID","class")
